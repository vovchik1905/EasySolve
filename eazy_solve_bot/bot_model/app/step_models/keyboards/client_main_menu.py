...
class ClientMainMenuKeyboard:
    def __init__(self, language: str, tg_id: int) -> None:
        ...
        self.balance_btn = InlineKeyboardButton(self.button_headings.BALANCE_HEADING + f" {main_request.get_user_balance_with_tg_id(tg_id)}",
        ...
        self.client_main_menu_keyboard = InlineKeyboardMarkup(row_width=2)
        self.client_main_menu_keyboard.add(self.new_order_btn)
        self.client_main_menu_keyboard.add(self.active_orders_btn)
        self.client_main_menu_keyboard.add(self.my_profile_btn)
        self.client_main_menu_keyboard.add(self.balance_btn)
        self.client_main_menu_keyboard.add(self.support_btn, self.reviews_btn)
        self.client_main_menu_keyboard.add(self.affiliate_program_btn)