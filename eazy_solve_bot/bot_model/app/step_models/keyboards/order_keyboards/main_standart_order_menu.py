...
class MainStandartOrderMenuKeyboard:
    def __init__(self, language: str, order_id: int) -> None:
        ...
        self.new_standart_order_importance_btn = InlineKeyboardButton(self.button_headings.NEW_STANDART_ORDER_IMPORTANCE_HEADING,
                                                    callback_data=ButtonCallbackData.NEW_STANDART_ORDER_IMPORTANCE_CALLBACK_DATA)

        #order_subject_value = check_subject_complete(order_id)
        #print(check_subject_complete(order_id))
        ...
        self.main_standart_menu_keyboard = InlineKeyboardMarkup(row_width=2)
        self.main_standart_menu_keyboard.add(self.new_standart_order_importance_btn, self.new_standart_order_subject_btn)
        self.main_standart_menu_keyboard.add(self.new_standart_order_comment_btn, self.new_standart_order_files_btn)
        self.main_standart_menu_keyboard.add(self.new_standart_order_deadline_time_btn)
        self.main_standart_menu_keyboard.add(self.up_order_settings_btn)
        self.main_standart_menu_keyboard.add(self.send_order_to_solvers_btn)


        
        self.main_standart_menu_keyboard.add(self.back_btn)