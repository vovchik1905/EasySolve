...
class MainVoluminousOrderMenuKeyboard:
    def __init__(self, language: str, order_id: int) -> None:
        ...
        self.new_voluminous_order_importance_btn = InlineKeyboardButton(self.button_headings.NEW_VOLUMINOUS_ORDER_IMPORTANCE_HEADING,
        ...
        self.main_voluminous_order_menu_keyboard = InlineKeyboardMarkup(row_width=2)
        self.main_voluminous_order_menu_keyboard.add(self.new_voluminous_order_importance_btn,
        ...
        self.main_voluminous_order_menu_keyboard.add(self.up_order_settings_btn)
        self.main_voluminous_order_menu_keyboard.add(self.send_order_to_solvers_btn)
        self.main_voluminous_order_menu_keyboard.add(self.back_btn)