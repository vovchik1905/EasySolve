...
class PartnerMainMenuKeyboard:
    def __init__(self, language: str) -> None:
        ...
        self.control_panel_btn = InlineKeyboardButton(self.button_headings.CONTROL_PANEL_HEADING,
                                                    callback_data=ButtonCallbackData.PARTNER_CONTROL_PANEL_CALLBACK_DATA)
        ...
        self.partner_main_menu_keyboard = InlineKeyboardMarkup(row_width=2)
        self.partner_main_menu_keyboard.add(self.control_panel_btn)
        self.partner_main_menu_keyboard.add(self.custom_menu_btn)